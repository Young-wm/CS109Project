...
public class GamePanel4 extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        for (Block4 block4 : allBlocks.values()) {
            ...
            if (skinMode == 0) {
                // 图片皮肤模式
                Image originalPieceImage = getPieceImage(block4.getId());
                ...
                if (originalPieceImage != null) {
                    ...
                    // 如果没有找到图片，使用纯色填充
                    g2d.setColor(blockColors.getOrDefault(block4.getId(), new Color(200, 200, 200)));
                ...
                // 纯色皮肤模式
                Color blockColor = blockColors.getOrDefault(block4.getId(), new Color(200, 200, 200));
