...
public class GameImageManager {
    ...
    // 图片加载路径
    private static final String IMAGE_PATH = "src/view/game2/images/";
    ...
    private static Image loadImage(String imageName) {
        ...
        try {
            ...
            if (file.exists()) {
                ...
                // 尝试从类路径加载
                URL resource = GameImageManager.class.getResource("/view/game2/images/" + imageName);
                if (resource != null) {
