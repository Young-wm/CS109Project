...
/*
*这个类提供了一下好用的方法：
* 1.它的几个field（board2,steps,moveHistory,elapsedTimeInSeconds,gameWon)的getter，注意gameWon的getter叫做isGameWon()；
...
public class GameState2 implements Serializable {
    ...
    public Stack<MoveRecord2> getMoveHistory() {
        return moveHistory;
    }
    ...
    public void setBoard(Board2 board2) {
        this.board2 = board2;
    }
    ...
    public void addMoveToHistory(MoveRecord2 record) {
        this.moveHistory.push(record);
    }
    //把某个记录添加到Stack里面的方法

    public MoveRecord2 popMoveFromHistory() {
    ...
    public boolean equals(Object o) {
        if (!(o instanceof GameState2 gameState2)) return false;
        return steps == gameState2.steps && elapsedTimeInSeconds == gameState2.elapsedTimeInSeconds && gameWon == gameState2.gameWon && Objects.equals(board2, gameState2.board2) && Objects.equals(moveHistory, gameState2.moveHistory);
    }

    @Override
    public int hashCode() {
        return Objects.hash(board2, steps, moveHistory, elapsedTimeInSeconds, gameWon);
    }
